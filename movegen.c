...
static void addQuietMove(const S_BOARD *pos, int move, S_MOVELIST *movelist) {
    ...
    if(pos->searchKillers[0][pos->ply] == move) {
        movelist->moves[movelist->count].score = 900000000;
    } else if(pos->searchKillers[1][pos->ply] == move) {
        movelist->moves[movelist->count].score = 800000000;
    } else {
...
static void addCaptureMove(const S_BOARD *pos, int move, S_MOVELIST *movelist) {
    ...
    movelist->moves[movelist->count].move = move;
    movelist->moves[movelist->count].score = mvvLvaScores[CAPTURED(move)][pos->pieces[FROMSQ(move)]] + 100000000;
    movelist->count++;
}
...
static void addEnPassantMove(const S_BOARD *pos, int move, S_MOVELIST *movelist) {
    ...
    movelist->moves[movelist->count].move = move;
    movelist->moves[movelist->count].score = 100000105;
    movelist->count++;
}
